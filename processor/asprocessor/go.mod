module github.com/open-telemetry/opentelemetry-collector-contrib/processor/asprocessor
...
require (
	...
	github.com/maxmind/MaxMind-DB v0.0.0-20240605211347-880f6b4b5eb6 // indirect
